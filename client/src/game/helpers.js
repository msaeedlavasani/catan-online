...
export function getSuggestions(game, myPlayer) {
      ...
      ? [
          {
            ...
            text:
              game.setupSubPhase === "settlement"
                ? "روستات رو روی تخته بذار."
                : "یه جاده وصل به روستای جدیدت بذار.",
          },
        ]
      : [];
  }
  ...
  suggestions.push(
    canRoad
      ...
      : {
          kind: "need",
          text: `جاده: ${describeMissing(missingFor(res, BUILD_COST.road))} کم داری.`,
        },
  );
  ...
  suggestions.push(
    canSettlement
      ...
      : {
          kind: "need",
          text: `روستا: ${describeMissing(missingFor(res, BUILD_COST.settlement))} کم داری.`,
        },
  );
  ...
  if (myPlayer.settlements.length > 0) {
    ...
    suggestions.push(
      canCity
        ...
        : {
            kind: "need",
            text: `شهر: ${describeMissing(missingFor(res, BUILD_COST.city))} کم داری.`,
          },
    );
  }
  ...
  suggestions.push(
    canDev
      ...
      : game.devDeck.length === 0
        ...
        : {
            kind: "need",
            text: `کارت توسعه: ${describeMissing(missingFor(res, BUILD_COST.devCard))} کم داری.`,
          },
  );
